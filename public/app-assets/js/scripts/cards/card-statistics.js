...
$(window).on('load', function () {
  ...
  var statisticsLineChartOptions1;
  var statisticsLineChartOptions2;
  var statisticsLineChartOptions3;
  var statisticsLineChartOptions4;
  var statisticsLineChartOptions5;
  ...
  var statisticsLineChart1 = document.querySelector('#statistics-line-chart1');
  var statisticsLineChart2 = document.querySelector('#statistics-line-chart2');
  var statisticsLineChart3 = document.querySelector('#statistics-line-chart3');
  var statisticsLineChart4 = document.querySelector('#statistics-line-chart4');
  var statisticsLineChart5 = document.querySelector('#statistics-line-chart5');
  ...
  statisticsLine3 = new ApexCharts(statisticsLineChart3, statisticsLineChartOptions3);
  statisticsLine3.render();

  statisticsLineChartOptions4 = {
    chart: {
      height: 160,
      type: 'line',
      toolbar: {
  ...
  statisticsLine4 = new ApexCharts(statisticsLineChart4, statisticsLineChartOptions4);
  statisticsLine4.render();

  statisticsLineChartOptions5 = {
    chart: {
      height: 160,
      type: 'line',
      toolbar: {
  ...
  statisticsLine5 = new ApexCharts(statisticsLineChart5, statisticsLineChartOptions5);
  statisticsLine5.render();
