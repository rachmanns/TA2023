...
$(function () {
  ...
  // Bor Covid
  // --------------------------------------------------------------------
  var columnChartEl = document.querySelector('#bor-covid'),
    columnChartConfig = {
      chart: {
        height: 300,
        type: 'bar',
      ...
      series: [
        {
          name: 'Jumlah TT Covid',
          data: [10, 20, 30, 25]
        },
        {
          name: 'Keterisian TT Covid',
          data: [20, 30, 40, 25]
        }
      ],
      xaxis: {
        categories: ['1 Maret', '2 Maret', '3 Maret', '4 Maret']
      },
      fill: {
        opacity: 1
      },
  ...
  // Isolasi Covid
  // --------------------------------------------------------------------
  var columnChartEl = document.querySelector('#isolasi-covid'),
    columnChartConfig = {
      chart: {
        height: 300,
        type: 'bar',
  ...
  // Icu Covid
  // --------------------------------------------------------------------
  var columnChartEl = document.querySelector('#icu-covid'),
    columnChartConfig = {
      chart: {
        height: 300,
        type: 'bar',
  ...
  xaxis: {
    categories: ['KOL', 'LETKOL', 'MAYOR', 'KAPT', 'LETTU', 'LETDA'],
  },
  yaxis: {
    title: {
      // text: '$ (thousands)'
  ...
  var chart = new ApexCharts(document.querySelector("#perwira"), options);
  chart.render();

  // Jumlah Personil Chart
  var options = {
    series: [{
    data: [44, 55]
  }],
  ...
  colors: [chartColors.column.series5],
  fill: {
    opacity: 1
  },
  tooltip: {
  ...
  var chart = new ApexCharts(document.querySelector("#jumlah-personil"), options);
  chart.render();
  ...
  xaxis: {
    categories: ['TNI AD', 'TNI AL', 'TNI AU'],
  },
  yaxis: {
    title: {
      // text: '$ (thousands)'
  ...
  var chart = new ApexCharts(document.querySelector("#personil"), options);
  chart.render();
