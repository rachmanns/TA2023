        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modal-form"><i
                            data-feather="plus"></i> Sub Komando</button>
                </div>
            </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-datatable">
                                            <table class="table table-responsive-xl" id="datatables-ajax">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Matra</th>
                                                        <th>Komando Name</th>
                                                        <th>Sub-Komando Name</th>
                                                        <th>Sub-Komando Code</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal_title">Tambah Baru Sub Komando</h4>
                ...
                <form id="form_data" class="form-data-validate" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="Angkatan Name" name="nama_subkomando" id="nama_subkomando"
        ...
        Array.prototype.filter.call($('#form_data'), function(form) {
            form.addEventListener('submit', function(event) {
                ...
                var url = (id_komando !== undefined && id_komando !== null) && id_komando ?
                    "{{ url('master/subkomando/update') }}" + "/" + id_komando :
