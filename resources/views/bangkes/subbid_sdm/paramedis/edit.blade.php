        ...
        <div class="content-wrapper">
            <div class="row breadcrumbs-top">
                <div class="col-12 mb-1">
                    <a href="/paramedis"><button type="button" class="btn btn-outline-primary"><i class="mr-75" data-feather="arrow-left"></i>Kembali</button></a>
                </div>
                <div class="col-12">
                    <h2 class="content-header-title float-left">Edit Daftar Paramedis</h2>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">             
                                        <div class="form-group form-input">
                                            ...
                                            <input type="text" id="jenis" class="form-control" placeholder="Jenis Ijazah">
