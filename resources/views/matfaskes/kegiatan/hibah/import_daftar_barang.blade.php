...
aria-labelledby="myModalLabel18" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('matfaskes.hibah.daftar_barang.excel_import') }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id_barang_masuk" value="{{ $ba_hibah->id_ba_hibah }}">
                ...
                <div class="modal-footer">
                    {{-- <div class="row">
                        <div class="text-right">
                            <a href="{{ url('template/detail_barang') }}"><< unggah Download Template  >></a>
                        </div>
                    </div> --}}
                    <div class="row">
                        <div class="text-right">
