...
<div class="modal fade text-left" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="default-form" autocomplete="off" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group form-input">
                        ...
                        <select name="id_mas_bek" id="edit_id_mas_bek" class="select2 form-control">
                    ...
                    <label>LN/DN</label>
                    <select class="select2 form-control" name="jenis_tujuan" id="edit_jenis_tujuan">
                    ...
                    <div class="form-group form-input mt-1">
                        ...
                        <div class="input-group input-group-merge form-input">
                            <input type="text" class="yearpicker form-control bg-white cursor-pointer" placeholder="Tahun" readonly name="tahun_anggaran" id="edit_tahun_anggaran"/>
