                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            ...
                            <td class="border-top-0 pl-0 pr-0 pb-0" id="no_nota_dinas">KJB/11/DN/PUSKES TNI/XI/2019/OPS</td>
                        </tr>
                        <tr>
                            <td class="border-top-0 pl-0 pb-0">Nominal</td>
                            <td class="border-top-0 pr-0 pb-0">:</td>
                            <td class="border-top-0 pl-0 pr-0 pb-0" id="nominal">1.389.110.000,-</td>
                        </tr>
                    </table>
