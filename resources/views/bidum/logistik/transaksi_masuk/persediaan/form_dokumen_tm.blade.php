    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-title">Tambah Dokumen Transfer Masuk - Persediaan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('bidum.logistik.transfer_masuk.store_transfer','persediaan') }}" class="default-form" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-input">
                        ...
                        <select name="pelaksana_tktm" id="pelaksana_tktm" class="form-control">
