            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-8">
                            <h2 class="content-header-title float-left mb-0">Daftar Transaksi Masuk - Persediaan
                            ...
                            <div class="card">
                                <div class="card-datatable">
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        @include('bidum.logistik.transaksi_masuk.persediaan.form_pengadaan')
                                        ...
                                        <div class="tab-pane fade" id="nav-transfer" role="tabpanel"
                                            ...
                                            @include('bidum.logistik.transaksi_masuk.persediaan.form_dokumen_tm')
                                            <div class="table-responsive">
                                        ...
                                        @include('bidum.logistik.transaksi_masuk.persediaan.form_hibah')
    ...
    <script>
        ...
        $("#fp-range").flatpickr({
            ...
            onChange: function(selectedDate) {
                ...
                pengadaan_table('#table-pengadaan-pusat', start, end, 'DIPPUS', 'P');
                pengadaan_table('#table-pengadaan-daerah', start, end, 'DIPDAERAH', 'P');
        ...
        $(function() {
            ...
            pengadaan_table('#table-pengadaan-pusat', from_date, to_date, 'DIPPUS', 'P');
            pengadaan_table('#table-pengadaan-daerah', from_date, to_date, 'DIPDAERAH', 'P');
        ...
        function report_list(from_date, to_date) {
            ...
            let url_transfer =
                `{{ url('bidum/logistik/transfer-masuk/list-transfer') }}/${from_date}/${to_date}/persediaan`;

            let url_hibah =
                `{{ url('bidum/logistik/hibah-masuk/list-hibah') }}/${from_date}/${to_date}/P`;
        ...
        $('#transfer_modal').on('hide.bs.modal', function(e) {
            $("#modal-title").html("Tambah Dokumen Transfer Masuk - Persediaan")
            $('#transfer_modal form')[0].reset();
            $('#transfer_modal form').attr('action',
                "{{ route('bidum.logistik.transfer_masuk.store_transfer', 'persediaan') }}");
        ...
        function edit_transfer(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#modal-title").html("Edit Dokumen Transfer Masuk - Persediaan")
        ...
        function edit_pengadaan(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#modal-title").html("Upload Dokumen Pengadaan - Persediaan")
        ...
        function edit_hibah(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#modal-title").html("Upload Dokumen Hibah - Persediaan")
