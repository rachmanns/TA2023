...
<div class="modal fade text-left" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('bidum/logistik/edit-excel-brg') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <a href="{{ url('bidum/logistik/download-edit/'.$in_tktm->id_in_tktm) }}" style="font-size: 12px;">
