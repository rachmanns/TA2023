        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <a href="{{ isset(Auth::user()->id_faskes) ? '/faskes/bor_edit' : '/yankesin/ubah_kelola_bor/' . $rs->id_rs }}"><button class="btn btn-primary">Edit Data BOR</button></a>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="row justify-content-center">
                                <div class="media pt-2">
                                    ...
                                    <div class="media-body my-auto">
                                        <h4 class="font-weight-bolder mb-0">Ruang Isolasi Non-Covid</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-0">
  ...
  var columnChartEl = document.querySelector('#rawat-inap'),
    columnChartConfig = {
      ...
      series: [
        {
          name: 'Terisi',
          data: [{{$data['VIP_isi'] ?? 0}}, {{$data['Kelas 1_isi'] ?? 0}}, {{$data['Kelas 2_isi'] ?? 0}}, {{$data['Kelas 3_isi'] ?? 0}}]
        },
        {
          name: 'Tersedia',
          data: [{{($data['VIP'] ?? 0)-($data['VIP_isi'] ?? 0)}}, {{($data['Kelas 1'] ?? 0)-($data['Kelas 1_isi'] ?? 0)}}, {{($data['Kelas 2'] ?? 0)-($data['Kelas 2_isi'] ?? 0)}}, {{($data['Kelas 3'] ?? 0)-($data['Kelas 3_isi'] ?? 0)}}]
        }
      ],
      xaxis: {
  ...
  var columnChartEl = document.querySelector('#icu'),
    columnChartConfig = {
      ...
      series: [
        {
          name: 'Terisi',
          data: [{{$data['ICU_isi'] ?? 0}}, {{$data['NICU_isi'] ?? 0}}, {{$data['ICCU_isi'] ?? 0}}, {{$data['HCU_isi'] ?? 0}}, {{$data['ICU Isolasi_isi'] ?? 0}}]
        },
        {
          name: 'Tersedia',
          data: [{{($data['ICU'] ?? 0)-($data['ICU_isi'] ?? 0)}}, {{($data['NICU'] ?? 0)-($data['NICU_isi'] ?? 0)}}, {{($data['ICCU'] ?? 0)-($data['ICCU_isi'] ?? 0)}}, {{($data['HCU'] ?? 0)-($data['HCU_isi'] ?? 0)}}, {{($data['ICU Isolasi'] ?? 0)-($data['ICU Isolasi_isi'] ?? 0)}}]
        }
      ],
      xaxis: {
