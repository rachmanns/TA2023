        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-form">Tambah BOR</button>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <form id="form_data" class="form-data-validate" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <br />
                        <h5>Data Tempat Tidur</h5>

                        <label>Jumlah Tempat Tidur Keseluruhan: </label>
                        <div class="form-group">
                        ...
                        <label>Jumlah Alokasi Tempat Tidur Ruang Isolasi Covid (Tersedia): </label>
                        <div class="form-group">
                        ...
                        <label>Jumlah Tempat Tidur Ruang Isolasi Covid Terpakai (Terisi): </label>
                        <div class="form-group">
                        ...
                        <label>Jumlah Alokasi Tempat Tidur ICU/HCU/COVID (Tersedia): </label>
                        <div class="form-group">
                        ...
                        <label>Jumlah Tempat Tidur ICU/HCU/COVID Terpakai (Terisi): </label>
                        <div class="form-group">
        ...
        Array.prototype.filter.call($('#form_data'), function(form) {
            form.addEventListener('submit', function(event) {
                ...
                var url = (id_komando !== undefined && id_komando !== null) && id_komando ?
                    "{{ url('yankesin/input/bor-update') }}" + "/" + id_komando :
                    "{{ url('yankesin/input/bor-store') }}";
