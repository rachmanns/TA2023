...
@section('main')
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="row pb-1">
                <div class="col-6">
                    <a href="/detail_non_bilateral"><button type="button" class="btn btn-outline-primary">
            ...
            <div class="row pb-1">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Input Kegiatan</h2>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="hadir" name="ket" class="custom-control-input"/>
                                        ...
                                        <div class="col-2">
                                            <div class="custom-control custom-radio">
                                                ...
                                                <label class="custom-control-label" for="batal">Batal Hadir</label>
                                            </div>   
                                        </div>
                                    </div>
