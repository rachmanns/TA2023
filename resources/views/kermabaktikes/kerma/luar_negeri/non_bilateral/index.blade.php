        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left">Data Multilateral</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mb-2">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ route('kerma.nonbilateral.create') }}"><button class="btn btn-primary">Tambah Data Multilateral</button></a>
                </div>
            </div>
            <div class="content-body">
                <section id="multilingual-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="table table-striped" id="nonbilateral-table">
                                    <thead>
                                        <tr>
                                            <th>Kegiatan</th>
                                            <th>No.</th>
...
@section('page_script')
    <script>
        ...
        $('#id_jenis_keg').change(function(){
            ...
            nonbilateral_table(id_jenis_keg,tahun)
        })
        ...
        function nonbilateral_table(id_jenis_keg='',tahun='') {
            let data = { id_jenis_keg: id_jenis_keg, tahun: tahun }
            var table = $('#nonbilateral-table').DataTable({
                destroy: true,
                processing: true,
                serverSide: true,
                scrollX: true,
                ajax: {
                    url: "{{ url('kerma/nonbilateral/list') }}",
                    method: 'POST',
                    data: data,
                    headers: {
