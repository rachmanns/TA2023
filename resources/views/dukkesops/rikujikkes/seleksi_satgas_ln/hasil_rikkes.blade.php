            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left">Hasil Rikkes Pratugas Satgas {{ strtoupper($jenis) }} - TA {{ $seleksi_satgas_ln->tahun_anggaran }}</h2>
                        </div>
                        <div class="col-12">
                            <h5>SATGAS BGC TNI KONGA</h5>
                            <span class="font-weight-bolder">{{ $seleksi_satgas_ln->tempat }}</span> <span>({{ indonesian_date_format($seleksi_satgas_ln->tanggal) }})</span>
                        </div>
                    </div>
                </div>
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <a data-toggle='modal' data-target='#import'><button class="btn btn-primary">Impor Data Seleksi Satgas</button></a>
                </div>
            </div>
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        @include('dukkesops.rikujikkes.seleksi_satgas_ln.edit_data_kegiatan')
                        @include('dukkesops.rikujikkes.seleksi_satgas_ln.import_data_kegiatan')
                    </div>
                </div>
            </div>
        </div>
...
@section('page_script')
    <script>
        ...
        $('#hasil').DataTable({
            scrollX: true,
            ajax: "{{ url('dukkesops/seleksi-satgas/list-data-kegiatan/'.$seleksi_satgas_ln->id_kegiatan_duk) }}",
            columns: [
                {
                    data: 'action',
                    name: 'action',
        ...
        function edit_data_kegiatan(e) {
            ...
            let action = `{{ url('dukkesops/seleksi-satgas') }}/`+id_data_kegiatan_duk;
            var url = `{{ url('dukkesops/seleksi-satgas-edit') }}/`+id_data_kegiatan_duk;
