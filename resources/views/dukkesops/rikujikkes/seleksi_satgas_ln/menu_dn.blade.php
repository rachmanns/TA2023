                ...
                <div class="content-header-left col-md-12 col-12 mb-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-md-12 col-12">
                            <h2 class="content-header-title float-left">Rikujikkes - Seleksi Satgas Dalam Negeri</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="content-body">
                <div class="row match-height">
                    <div class="col-md-6 col-12">
                        <a href="{{ url('dukkesops/seleksi-satgas/dn/pratugas') }}">
                            <div class="card mb-3">
                    ...
                    <div class="col-md-6 col-12">
                        <a href="{{ url('dukkesops/seleksi-satgas/dn/purnatugas') }}">
                            <div class="card mb-3">
