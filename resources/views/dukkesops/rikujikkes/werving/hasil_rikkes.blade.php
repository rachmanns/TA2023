            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Hasil Rikkes Werving - Kategori Rikkes - TA {{ $werving->tahun_anggaran }}</h2>
                        </div>
                        <div class="col-12">
                            <span class="font-weight-bolder">{{ $werving->tempat }}</span> <span>({{ \Carbon\Carbon::parse($werving->tanggal)->locale('id')->isoFormat('D MMMM YYYY'); }})</span>
                        </div>
                    </div>
                </div>
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <a data-toggle='modal' data-target='#import'><button class="btn btn-primary">Impor Data Werving</button></a>
                </div>
            </div>
            <div class="content-body">
                    ...
                    <div class="col-xl-12 col-md-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Detail Nakes</h4>
                            </div>
                            <div class="card-body statistics-body">
                                <div class="row">
                                    @foreach ($jumlah_dokter as $item)
                                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0 mr-3">
                                            <div class="media">
                                                <div class="media-body my-auto">
                                                    <h4 class="font-weight-bolder">{{ $item['ket_hasil']??'' }}</h4>
                                                    <p class="card-text font-small-5 mb-0">Dokter Umum : {{ $item['DOKTER UMUM']??$item['Dokter Umum']??0 }}</p>
                                                    <p class="card-text font-small-5">Dokter Gigi : {{ $item['DOKTER GIGI']??$item['Dokter Gigi']??0 }}</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <table class="table table-striped" id="hasil">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center pl-4 pr-4 border-right border-left">Nama <br> Kelas Prodi <br> Jenis Kelamin</th>
                        ...
                        @include('dukkesops.rikujikkes.werving.edit_data_kegiatan')
                        @include('dukkesops.rikujikkes.werving.import_data_kegiatan')
                    </div>
                </div>
            </div>
        </div>
...
@section('page_script')
    <script>
        ...
        $('#hasil').DataTable({
            scrollX: true,
            ajax: "{{ url('dukkesops/werving/list-data-kegiatan/'.$werving->id_kegiatan_duk) }}",
            columns: [
                {
                    data: 'action',
                    name: 'action',
        ...
        function edit_data_kegiatan(e) {
            ...
            let action = `{{ url('dukkesops/werving') }}/`+id_data_kegiatan_duk;
            var url = `{{ url('dukkesops/werving') }}/`+id_data_kegiatan_duk+'/edit';
