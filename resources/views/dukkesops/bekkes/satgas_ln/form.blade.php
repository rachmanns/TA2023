    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-title">Tambah Bekkes Satgas Luar Negeri</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ url('dukkesops/satgas-ln') }}" class="default-form" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-12 mt-1 form-input">
                        ...
                        <div class="col-md-12 col-12 mt-1 form-input">
                            ...
                            <input type="number" class="form-control" placeholder="Jumlah Personil" name="jumlah" id="jumlah">
                            <div class="invalid-feedback"></div>    
                        </div>
                        <div class="col-md-12 col-12 mt-1 form-input">
