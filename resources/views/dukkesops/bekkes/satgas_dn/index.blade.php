        ...
        <div class="content-wrapper">
                ...
                <div class="content-header-left col-md-12 col-12 mb-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-md-12 col-12">
                            <h2 class="content-header-title float-left">Daftar Bekkes Satgas Dalam Negeri</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mb-1">
                ...
                <div class="col-md-9 col-4 text-right">
                    <a data-toggle='modal' data-target='#add'><button class="btn btn-primary">Input Data Satgas DN</button></a>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <table class="table table-striped" id="dn">
                                    <thead>
                                        <tr>
                                            <th style="min-width: 50px">Tahun</th>
                                            <th style="min-width: 100px">Satgas</th>
                            ...
                            @include('dukkesops.bekkes.satgas_dn.form')
                        </div>
                    </div>
                </section>
            </div>
    ...
    <script>
        ...
        function dn_list(tahun='') {
            ...
            $('#dn').DataTable({
                ...
                scrollX: true,
                ajax: {
                        url: "{{ url('dukkesops/satgas-dn/list') }}",
                        method: 'POST',
                        data: data,
                        headers: {
        ...
        function edit_bekkes_duk(e) {
            ...
            let action = `{{ url('dukkesops/satgas-dn') }}/${id_bekkes_duk}`;
            var url = `{{ url('dukkesops/satgas-dn') }}/${id_bekkes_duk}/edit`;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#modal-title").html("Edit Bekkes Satgas Dalam Negeri")
        ...
        $("#add").on("hide.bs.modal", function() {
            ...
            $("#modal-title").html("Tambah Bekkes Satgas Dalam Negeri")
            $('#add form')[0].reset();
            $('#add form').attr('action', "{{ route('dukkesops.satgas-dn.store') }}");
