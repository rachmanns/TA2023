    ...
    <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modal-form">Create New Role</button>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close mr-0 mt-0" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                        ...
                        <div class='form-group'>
                            <div class="row">
                                ...
                                @foreach ($permissions_list['group'] as $val)
                                    <div class="col-sm-4">
                                        <span class="badge bg-primary mt-1 mb-1">{{ $val }}</span>
                                        @foreach ($permissions_list['function'][$val] as $index => $value)
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label"
                                                    for="{{ $permissions_list['function'][$val][$index]['name'] . $i }}">{{ Str::ucfirst($value['name']) }}</label>
                                            </div>
                                            @php
...
@section('page_script')
    ...
    <script>
        ...
        $(document).on('click', '#create', function(event) {
            ...
            $('#modal-title').text('Creat New Role');
